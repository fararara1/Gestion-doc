...
<div class="page-header-custom">
    ...
    <a href="{{ route('projects.create') }}" class="btn-gold-sm">
            ...
            <tbody>
                @forelse($projects as $project)
                    <tr>
                        ...
                        <td>
                            <span class="badge-gold">{{ $project->documents_count }}</span>
                        </td>
                        <td class="text-end">
                            <a href="{{ route('projects.show', $project) }}" class="btn-icon btn-icon-info" title="Consulter">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('projects.edit', $project) }}" class="btn-icon btn-icon-warning" title="Modifier">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-4" style="color: var(--navy-600);">Aucun projet trouvé.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
